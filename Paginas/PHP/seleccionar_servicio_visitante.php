...
// 🔹 NO validar sesión para visitantes

// Obtener tienda de sesión (debe estar seteada desde pantalla de espera)
if (!isset($_SESSION["id_tienda"])) {
    die("❌ Debes seleccionar una tienda primero");
}

$id_tienda = $_SESSION["id_tienda"];
$nombre_tienda = $_SESSION["nombre_tienda"] ?? "ClickMatic";
...
<div class="contenedor">
    ...
    <div class="cliente-info">
        <p>Visitante</p>
        <strong><?php echo htmlspecialchars($nombre_tienda); ?></strong>
    </div>
...
function seleccionarServicio(idServicio, nombreServicio) {
    ...
    // Llamar a un endpoint para generar el turno de visitante
    fetch("../../Recursos/PHP/generar_turno_visitante.php", {
        method: "POST",
        headers: {
